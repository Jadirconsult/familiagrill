  ...
  return (
    <section id="cozinhas" className="border-t border-char py-20 sm:py-28">
      <div className="shell">
        ...
        <div className="mt-12 grid gap-px bg-char sm:mt-14 md:grid-cols-3">
...
function KitchenCard({
  ...
  return (
    <div
      ref={ref}
      className={`reveal group border border-transparent bg-coal p-8 transition-colors sm:p-10 md:p-6 lg:p-10 ${tone.hover}`}
    >
      <span className={`block h-1 w-12 ${tone.rule}`} aria-hidden />
      {/* Em tablet as três colunas ficam estreitas: o nome cede antes de estourar. */}
      <h3 className="display mt-6 text-4xl text-cream md:text-3xl lg:text-4xl">
        {kitchen.name}
      </h3>
